        ...
        public MeterRegistry produce() {
            return new AppOpticsMeterRegistry(new AppOpticsConfig() {
                ...
                public String get(final String propertyName) {
                    return config.getValue("microprofile.metrics." + prefix() + "." + propertyName, String.class);
                }
    ...
    public static class AtlasBackendProducer {
        ...
        public MeterRegistry produce() {
            return new AtlasMeterRegistry(new AtlasConfig() {
                @Override
                public String get(final String propertyName) {
                    return config.getValue("microprofile.metrics.atlas." + propertyName, String.class);
                }
            }, io.micrometer.core.instrument.Clock.SYSTEM);
        }
    }
    ...
    public static class ElasticBackendProducer {
        ...
        public MeterRegistry produce() {
            return new ElasticMeterRegistry(new ElasticConfig() {
                @Override
                public String get(final String propertyName) {
                    return config.getOptionalValue("microprofile.metrics." + prefix() + "." + propertyName, String.class)
                            .orElse(null);
                }
            }, io.micrometer.core.instrument.Clock.SYSTEM);
        }
